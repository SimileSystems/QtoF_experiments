...
function create_ui_message_enum() {
...
function create_widget_type_enum() {

  /* Read the file with the ui messages. */
  var fs = require('fs');
  fs.readFile('./WidgetTypes.h', 'utf8', function (err,data) {
...
create_ui_message_enum();
create_widget_type_enum();
